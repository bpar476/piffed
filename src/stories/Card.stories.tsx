...
export const Normal: React.VFC = () => (
  <Card
    content="It only accepts a string for the content. You can specify an external link to be loaded when clicking the card. You can also choose the image shown and its alt text."
...
export const Large: React.VFC = () => (
  <LargeCard
    ...
    content="You can put any valid react element as the content. This makes it highly flexible"
